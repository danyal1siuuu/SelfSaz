...
PLANS_DATA: dict[str, dict[str, Any]] = {
    "normal": {
        ...
        "max_friends": 3, "max_enemies": 3, "allowed_fonts": list(range(1, 6)),
    ...
    "iron": {
        ...
        "max_friends": 5, "max_enemies": 5, "allowed_fonts": list(range(1, 9)),
    ...
    "bronze": {
        ...
        "max_friends": 15, "max_enemies": 15, "allowed_fonts": list(range(1, 13)),
    ...
    "silver": {
        ...
        "max_friends": 40, "max_enemies": 40, "allowed_fonts": list(range(1, 19)),
    ...
    "gold": {
        ...
        "max_friends": 100, "max_enemies": 100, "allowed_fonts": list(range(1, 26)),
    ...
    "diamond": {
        ...
        "max_friends": 9999, "max_enemies": 9999, "allowed_fonts": list(range(1, 26)),
...
def render_plan_dashboard(profile: dict[str, Any]) -> str:
    ...
    return (
        ...
        f"🔤 فونت: `{len(cfg['allowed_fonts'])}/25`\n"
